...
def main():
    ...
    while True:
        ...
        is_anomalous = "Error" in logs or "Exception" in logs or "Timeout" in logs or "Memory" in logs or "CPU" in logs or cpu_val > 0.05

        current_time = time.time()

        
        if is_anomalous and (current_time - last_alert_time > cooldown_seconds):
